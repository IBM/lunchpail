...
HELM_DEMO_SECRETS="--set global.s3AccessKey=lunchpail --set global.s3SecretKey=lunchpail --set global.s3Endpoint=http://s3.$NAMESPACE_SYSTEM.svc.cluster.local:9000 --set global.buckets.test=internal-test-bucket"
