...
do
    ...
    else echo "❌ FAIL mismatched sha256 on output file file=$actual expected=$expected actual_sha256=$actual_sha256 expected_sha256=$expected_sha256 test=$TEST_NAME" && exit 1
    fi
