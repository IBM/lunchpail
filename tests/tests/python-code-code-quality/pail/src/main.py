...
code_quality = {}
code_quality["contents_column_name"] =  "contents"
code_quality["language_column_name"] = "language"
...
def transform(table: pa.Table, file_name: str = None) -> tuple[list[pa.Table], dict]:
    ...
    validate_columns(
        table, [code_quality["contents_column_name"], code_quality["language_column_name"]]
    )
    ...
    contents = table.column(code_quality["contents_column_name"]).to_pylist()
    languages = table.column(code_quality["language_column_name"]).to_pylist()
    ...
    for i, c in enumerate(contents):
        ...
        char_token_ratio_values.append(calculate_char_token_ratio(c, tokenizer)["char_token_ratio"])
    ...
    table = add_column(table=table, name="line_mean", content=line_mean_values)
    table = add_column(table=table, name="line_max", content=line_max_values)
    table = add_column(table=table, name="total_num_lines", content=no_lines_values)
    table = add_column(table=table, name="avg_longest_lines", content=avg_longest_lines_values)
    table = add_column(table=table, name="alphanum_frac", content=alphanum_frac_values)
    table = add_column(table=table, name="char_token_ratio", content=char_token_ratio_values)
    table = add_column(table=table, name="autogenerated", content=is_autogenerated_values)
    table = add_column(table=table, name="config_or_test", content=is_config_or_test_values)
    table = add_column(table=table, name="has_no_keywords", content=has_no_keywords_values)
    table = add_column(table=table, name="has_few_assignments", content=has_few_assignments_values)
    table = add_column(table=table, name="is_xml", content=is_xml_values)
    table = add_column(table=table, name="is_html", content=is_html_values)
