...
export function taskqueues(props: ApplicationSpecEvent) {
  const taskqueues = props.spec.inputs ? props.spec.inputs[0].sizes : undefined
  const taskqueueNames = !taskqueues ? [] : Object.values(taskqueues).filter(Boolean)
