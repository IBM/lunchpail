...
export default (
  <>
    Your Job's <strong>{code}</strong> is used by <strong>Workers</strong> in a <strong>{workerpool}</strong> to process{" "}
    <strong>Tasks</strong>. It may include required bindings to{" "}
