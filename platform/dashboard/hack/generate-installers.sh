...
# lite deployment
helm template --include-crds codeflare-platform "$TOP"/platform $HELM_DEMO_SECRETS --set tags.examples=false --set tags.defaults=false --set tags.full=false --set tags.core=true > "$OUTDIR"/jaas-lite.yml
