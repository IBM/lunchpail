...
import { SignInMethods } from "../core/auth.ts";
import { type ExistingAccount, type FirebaseError } from "../core/firebase.ts";
import {
  LoginButton,
  LoginButtonProps,
} from "../layout/components/LoginButton.tsx";
        ...
        ctx.set(LoginDialogState, {
          ...
          async onClose(event: React.MouseEvent, reason) {
            ...
            if (!event.isDefaultPrevented()) {
              ...
              const fb = await import("../core/firebase.ts");
